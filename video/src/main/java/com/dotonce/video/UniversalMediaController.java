...
public class UniversalMediaController extends FrameLayout {
    ...
    public void reset() {
        ...
        mTurnButton.setImageResource(R.drawable.v_player);
    ...
    private final OnTouchListener mTouchListener = (v, event) -> {
    ...
    private void updatePausePlay() {
        if (mPlayer != null && mPlayer.isPlaying()) {
            mTurnButton.setImageResource(R.drawable.v_pause);
//            mCenterPlayButton.setVisibility(GONE);
        } else {
            mTurnButton.setImageResource(R.drawable.v_player);
//            mCenterPlayButton.setVisibility(VISIBLE);
    ...
    void updateScaleButton() {
        if (mIsFullScreen) {
            mScaleButton.setImageResource(R.drawable.v_close_full);
        } else {
            mScaleButton.setImageResource(R.drawable.v_open_full);
        }
    }
