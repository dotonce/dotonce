...
public class ImageUploaderClass {
    ...
    public static void uploadImage(String ip, byte [] filePath,String name, String folder_name,  onSuccessfulTask task) {
        try {
            AppImagesService apiInterface = RetrofitApiClient.getClient(ip).create( AppImagesService.class);
            //File file = new File(filePath);
            RequestBody requestFile = RequestBody.create(filePath,MediaType.parse("*/*"));
