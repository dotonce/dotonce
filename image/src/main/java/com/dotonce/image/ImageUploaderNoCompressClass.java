...
public class ImageUploaderNoCompressClass {
    ...
    public static void uploadImage(String ip, String filePath,String name, String folder_name,  onSuccessfulTask task) {
        try {
